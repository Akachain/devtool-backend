...
const loggerComon = require('./logger');
...
async function getClientForOrg(userorg, username) {
  ...
  hfc.setConfigSetting(`${userorg}-connection-profile-path`, path.join(__dirname, '../../devtool-community-network/artifacts', `${userorg}.yaml`));
